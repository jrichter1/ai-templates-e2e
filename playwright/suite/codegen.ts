...
export class CodegenTest implements PlaywrightSuite {
  appTest(name: string, namespace: string) {
    describe('Code generation UI tests', () => {
      let page: Page;
      let browser: Browser;
      ...
      it('text prompt works', async () => {
        ...
        await textbox.fill('generate a hello world program in python, without any explanation');
